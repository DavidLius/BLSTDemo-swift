...
final class SignTests: XCTestCase {
    ...
    func test_sign_vectors() async throws {
        ...
        try await doTestSuite(
            ...
            debugPrint("[DEBUG]: MESSAGE:\(String.init(data: message, encoding: .utf8) ?? "")")
...
struct SignTestSuite: TestSuite, Decodable {
    ...
    struct Test: Decodable {
        ...
        init(Msg: String, Ciphersuite: String, G1Compressed: String, G2Compressed: String, BLSPrivKey: String, BLSPubKey: String, BLSSigG2: String) {
            self.Msg = Msg
            self.Ciphersuite = Ciphersuite
            self.G1Compressed = G1Compressed
            self.G2Compressed = G2Compressed
            self.BLSPrivKey = BLSPrivKey
            self.BLSPubKey = BLSPubKey
            self.BLSSigG2 = BLSSigG2
        }
